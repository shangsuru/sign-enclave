...
App_Cpp_Files := App/App.cpp $(wildcard App/Edger8rSyntax/*.cpp) $(wildcard App/TrustedLibrary/*.cpp) App/ErrorSupport.cpp App/CommandLineParser.cpp App/FileIO.cpp Include/Base64Encoding.cpp
